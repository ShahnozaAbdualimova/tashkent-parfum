<template>
  <div
    class="bg-white w-[270px] border border-white rounded-xl overflow-hidden p-4 group cursor-pointer hover:shadow-xl transition-all duration-300"
  >
    <!-- logo -->
    <div class="flex items-center mb-4">
      ...
      />
      <div class="ml-3">
        <h2 class="text-xl font-normal text-black-500">{{ brand.title }}</h2>
