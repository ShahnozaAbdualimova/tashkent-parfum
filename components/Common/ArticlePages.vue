<template>
  <div class="container mx-auto p-10 bg-white rounded-2xl">
    <div class="p-10">
      ...
      <h2 class="text-2xl font-semibold mb-6">И заголовок 2 будет выглядеть так</h2>

      <p class="mb-6 text-base text-black-500">
        Интернет-магазин элитной парфюмерии и косметики PARFUM TASHKENT был
        создан в 2019 году. Каждый день мы заботимся о расширении ассортимента,
        улучшении функциональных возможностей электронного оборудования и
        доставки, чтобы ваши покупки были комфортными и приносили исключительно
      ...
      <p class="mb-6 text-base text-black-500">
        ...
        прекратить работу своих магазинов на территории Российской Федерации. Об
        этом сеть, принадлежащая группе компаний LVMH (Louis Vuitton Moët
      ...
      <blockquote class="border-l-2 border-red-500 pl-2 my-6">
        <div class="rounded-2xl p-3 bg-red-700 flex gap-4">
          ...
          <p class=" text-lg font-normal text-black-500">
            ...
            на главном экране приложения <span class="font-medium text-black-500">Parfume Investor.</span>
          </p>
        </div>
      </blockquote>
