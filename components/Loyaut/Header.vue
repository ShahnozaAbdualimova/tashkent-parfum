      ...
      <div class="w-full flex items-center justify-between container mx-auto">
        <div class="flex gap-8">
          ...
          <div class="flex items-center gap-4">
            <button
              class="flex gap-2 py-2 ps-2 pe-3 border rounded-lg text-sm catalog text-white hover:bg-gray-100"
            >
              <span class="icon-list text-2xl"></span>
              Каталог
            </button>
            <div
              class="flex items-center gap-2 px-2 bg-[#F2F3F5] text-[#6F6F6F] rounded-lg"
            >
