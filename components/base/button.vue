...
const computedClass = computed(() => {
  ...
  const variantClass = {
    ...
    danger:
      "font-proxima rounded-md transform transition-transform active:scale-95 bg-red-500 hover:shadow-[0_0_10px_1px_rgba(246,37,89,0.5)] duration-300 px-4 py-2.5 font-normal text-sm text-white",
