  ...
  <ModalWrapper>
    <div class="flex items-center justify-center gap-4">
     ...
     <div class="flex flex-col gap-y-3 ">
       <div
           :style="{
          backgroundImage: `url(${image}),linear-gradient(180deg, #00000003, #090808)`,
       ...
       >
         ...
         >
           <p class="text-gray-500 text-[14px] font-medium">Yangiliklar</p>
           <h3
       ...
       <button class="py-2.5 px-5 rounded-lg bg-red-500  text-white-default active:scale-95 duration-200 ease-in-out">Подробнее</button>
     </div>
