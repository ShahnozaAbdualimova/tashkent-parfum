      ...
      <div class="grid grid-cols-12 space-x-6 mt-6 items-start">
        <div class="bg-white rounded-xl w-full lg:col-span-8 col-span-12">
          <Transition name="fade" mode="out-in">
            <CheckoutAddress v-if="checkoutStatus === 'address'" @switchToContacts="showContacts" />
            <CheckoutContacts v-else-if="checkoutStatus=== 'contacts'" @switchToAddress="showAddress" @switchToPayment="showPayment"/>
