    ...
    <div class="flex flex-col lg:flex-row gap-4 lg:gap-6">
      ...
      <div class="w-full lg:w-[380px] mb-6 lg:mb-11 space-y-6">
        <div class="bg-white p-4 md:p-5 rounded-lg shadow-sm">
          <div
            class="flex flex-col sm:flex-row lg:flex-col gap-4 sm:items-center lg:items-start justify-between mb-4"
          >
            <h4 class="text-black-500 text-xl md:text-2xl font-bold">
              #346283
            </h4>
        ...
        <div class="bg-white p-4 md:p-5 rounded-lg shadow-sm">
          <h3 class="font-bold text-xl md:text-2xl text-black-500">
            Всего товаров
          </h3>
