<template>
  <div class="">
    <div class="container mx-auto px-4 py-8 ">
      <h1 class="text-3xl font-bold mb-8">Обратная связь</h1>
      ...
      <div class="grid md:grid-cols-2 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm ">
          <form @submit.prevent="submitForm">
            ...
            <div class="flex justify-end">
              <BaseButton
                :variant="'basketBtn'"
                class="w-[210px] flex justify-end items-end"
                :type="'button'"
                :disabled="false"
              >
                Отправить
        ...
        <!-- Company Info -->
        <div class="bg-white p-6 rounded-lg shadow-sm">
          <h2 class="text-2xl font-bold mb-6">Tashkent Parfume</h2>
          <p class="text-gray-600 mb-8">
          ...
          <div class="space-y-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-sm text-gray-500">Время работы</p>
                <p>09:00 - 19:00</p>
              </div>
            </div>
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-sm text-gray-500">Адресс</p>
                <p>Чиланзар 28/16</p>
              </div>
            </div>
    ...
    <div style="position: relative; overflow: hidden" class=" overflow-hidden mt-8">
     <iframe
